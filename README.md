<body>
    <div align="center">
        ...
        <p>
            <strong>WhatsYpzck — WhatsApp Destek & Arıza Bildirim Asistanı</strong><br>
            Node.js + TypeScript ile geliştirildi · Gemini, OpenAI GPT, Claude yapay zeka entegrasyonu<br>
            Gerçek zamanlı hava durumu · Arıza akışı · Admin yönetim paneli
        </p>
        <p><em>Developed &amp; maintained by <strong>Ç.Kurtoğlu</strong></em></p>
    </div>
</body>

## İmza / Maintainer

- **Geliştirici:** Ç.Kurtoğlu
- **Proje:** WhatsYpzck WhatsApp Destek Botu
- **Lisans:** MIT — Copyright © 2026 Ç.Kurtoğlu
...
```bash
git clone https://github.com/CaqlayanKurtoglu/WhatsYpzck.git
cd WhatsYpzck
cp .env.example .env
...
**Open to suggestions!** Submit feature requests via [GitHub Issues](https://github.com/CaqlayanKurtoglu/WhatsYpzck/issues).
...
### Getting Help
- Report bugs via [GitHub Issues](https://github.com/CaqlayanKurtoglu/WhatsYpzck/issues)
...
- Destek veren ve katkıda bulunan herkese teşekkürler

---

<div align="center">
    <p>Geliştirici: <strong>Ç.Kurtoğlu</strong></p>
    <p>WhatsYpzck WhatsApp Destek &amp; Arıza Bildirim Botu</p>
    <p>Copyright &copy; 2026 Ç.Kurtoğlu &mdash; MIT Lisansı</p>
    <p>
        <a href="https://github.com/CaqlayanKurtoglu/WhatsYpzck">GitHub</a> •
        <a href="https://github.com/CaqlayanKurtoglu/WhatsYpzck/issues">Hata Bildir</a>
    </p>
</div>
