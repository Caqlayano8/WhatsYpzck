/**
 * Author: Ç.Kurtoğlu
 * Description: i18n Utility - Çok dilli destek
 */

import { COUNTRIES, CountryConfig } from "../location/countries.util";
    ...
    fr: {
        ...
        getMessages: {
            ...
            captions: [
                ...
                "Vous n'avez toujours pas enregistré WhatsYpzck dans votre liste de contacts? Faites le vite et maintenant ! Sinon vous ne pourrez pas utiliser le bot à l'avenir !",
                ...
                "Vous ignorez certainement quelques fonctionnalités de WhatsYpzck. Tapez {prefix}help pour voir ce que WhatsYpzck peut faire !"
            ],
        },
    ...
    en: {
        ...
        getMessages: {
            ...
            captions: [
                ...
                "Still haven't saved WhatsYpzck to your contact list? Do it quickly and now! Otherwise, you won't be able to use the bot in the future!",
                ...
                "You probably don't know some of WhatsYpzck's features. Type {prefix}help to see what WhatsYpzck can do!"
            ],
        },
